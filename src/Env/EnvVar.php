...
enum EnvVar: string implements EnvironmentVarInterface
{
	...
	case FILE_STORAGE_ENV = 'FILE_STORAGE_ENV';
	...
	case FILE_STORAGE_PREAUTH_READ_IMAGES_KEY = 'FILE_STORAGE_PREAUTH_READ_IMAGES_KEY';
	case FILE_STORAGE_PREAUTH_READ_BACKUPS_KEY = 'FILE_STORAGE_PREAUTH_READ_BACKUPS_KEY';
